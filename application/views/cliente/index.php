<form action="<?= base_url('cliente') ?>" method="get" class="mt-2">
	...
	<div class="form-group col-2 col-sm-12 col-md- col-lg-3">
		...
		<input type="text" name="termo" class="form-control" value="<?=isset($_GET['termo'])?$_GET['termo']:'';?>" value="<?=(isset($filter['termo'])?$filter['termo']:'')?>" placeholder="Pesquisa nome, CPF ou CNPJ"/>            
		</div>
	</div>
